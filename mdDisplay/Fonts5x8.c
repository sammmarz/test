/**
 \file
Файл содержит шрифт, содержащий символвы в последовательности кодировки ASCII (начиная с 32 символа).

Все новые символы в случае необходимости должны добавляться в конец массива, чтобы не сбивать последовательность ASCII.
*/
...
char Font5x8 [][5] =
{
    ...
    {0x00, 0x00, 0x3c, 0x7e, 0x7e}, //круг начало
    {0x7e, 0x7e, 0x3c, 0x00, 0x00}, //круг конец
    {0x07, 0x05, 0x07, 0x00, 0x00} //градус
};
